        ...
        <div className="card h-100 d-flex flex-column mb-4 rounded-3 shadow-sm">
          ...
          <div className="card-body d-flex flex-column flex-grow-1">
            ...
            <ul className="list-unstyled mt-3 mb-4">
              <li>10 dogs you can match with</li>
